...
/*   Updated: 2023/10/20 11:04:09 by ayakoubi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string name, bool sign, int gSign, int gExec): name(name), sign(sign), grade_sign(gSign), grade_exec(gExec)
{
}
